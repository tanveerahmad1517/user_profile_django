...
urlpatterns = [
    ...
    url(r'profile/edit_avatar/crop', views.edit_avatar_crop, name="edit_avatar_crop"),
    url(r'profile/edit_avatar/rotate/$', views.edit_avatar_rotate, name="edit_avatar_rotate"),
